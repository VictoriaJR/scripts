...
#
# Usage: python remove_coloured_taxa.py [fasta_file] [coloured_tree] [colour_code_to_remove] [colour_code_to_extract]
# 
# Example 1: Remove red taxa and extract blue taxa
# python remove_coloured_taxa.py example.fasta coloured.tre ff0000 0000ff
# 
# Example 2: Just remove red taxa
# python remove_coloured_taxa.py example.fasta coloured.tre ff0000
#
# Example 3: Just extract blue taxa
# python remove_coloured_taxa.py example.fasta coloured.tre NA 0000ff
