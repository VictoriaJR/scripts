"""
    QIIME2_18S_db(dir_path, sequencing_technology, sequencing_type, primers, steps)
Execute the qiime2 pipeline consisting of the steps: "download_fastq", "import_data", "trim_data_1", "trim_data_2", "join_reads", "derep_vsearch", "denovo_clus_OTU97", "taxonomy_OTU", "16S_taxonomy_filter", "rename_OTU_tax_bioproj" 
Inputs:
...
function QIIME2_18S_db(dir_path::AbstractString, bio_project::AbstractString, sequencing_technology::AbstractString, sequencing_type::AbstractString, primer_fwd::AbstractString, primer_rev::AbstractString, steps=String[])
    if dir_path[end] != "/"
        dir_path *= "/"
    end
